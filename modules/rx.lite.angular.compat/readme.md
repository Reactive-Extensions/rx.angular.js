...
# `rx.angular.lite.compat.js` - Reactive Extensions Bindings for AngularJS Lite Compat for older browsers.

This library serves as a bridge between the [Reactive Extensions for JavaScript (RxJS)](https://github.com/Reactive-Extensions/RxJS) Lite Compat library for older browsers and [AngularJS](http://angularjs.org/).
